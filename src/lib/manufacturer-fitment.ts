...
const MODELS: Array<{ re: RegExp; make: string; model: string; generation?: string }> = [
  ...
  { re: /\bs[-\s]?3\b/, make: "Audi", model: "S3" },
  { re: /\bs[-\s]?4\b/, make: "Audi", model: "S4" },
  { re: /\bq[-\s]?8\b/, make: "Audi", model: "Q8" },
  ...
  { re: /\bcupra\b.*\bleon\b|\bleon\b.*\bcupra\b/, make: "Cupra", model: "Leon" },
  { re: /\bformentor\b/, make: "Cupra", model: "Formentor" },
  ...
  { re: /\bevoque\b/, make: "Land Rover", model: "Range Rover Evoque" },
  { re: /\bdiscovery\b/, make: "Land Rover", model: "Discovery" },
  { re: /\bdefender\b/, make: "Land Rover", model: "Defender" },
  { re: /\brange rover sport\b/, make: "Land Rover", model: "Range Rover Sport" },
  { re: /\bmini\b/, make: "MINI", model: "Cooper" },
  { re: /\bi30\b/, make: "Hyundai", model: "i30" },
  { re: /\btucson\b/, make: "Hyundai", model: "Tucson" },
  { re: /\bi20\b/, make: "Hyundai", model: "i20" },
  { re: /\bbrz\b/, make: "Subaru", model: "BRZ" },
  { re: /\bwrx\b/, make: "Subaru", model: "WRX" },
  { re: /\bimpreza\b/, make: "Subaru", model: "Impreza" },
  { re: /\bforester\b/, make: "Subaru", model: "Forester" },
  { re: /\bgr86\b/, make: "Toyota", model: "GR86" },
  { re: /\bmazda\s*3\b/, make: "Mazda", model: "3" },
  { re: /\bmazda\s*6\b/, make: "Mazda", model: "6" },
  { re: /\bcx-?5\b/, make: "Mazda", model: "CX-5" },
  { re: /\bclio\b/, make: "Renault", model: "Clio" },
  { re: /\bmegane\b/, make: "Renault", model: "Megane" },
  { re: /\bceed\b/, make: "Kia", model: "Ceed" },
  { re: /\bsportage\b/, make: "Kia", model: "Sportage" },
  { re: /\bgiulia\b/, make: "Alfa Romeo", model: "Giulia" },
  { re: /\bgiulietta\b/, make: "Alfa Romeo", model: "Giulietta" },
  { re: /\bwrangler\b/, make: "Jeep", model: "Wrangler" },
  { re: /\bgrand cherokee\b/, make: "Jeep", model: "Grand Cherokee" },
  { re: /\b308\b/, make: "Peugeot", model: "308" },
  { re: /\b208\b/, make: "Peugeot", model: "208" },
  { re: /\blancer\b/, make: "Mitsubishi", model: "Lancer" },
  { re: /\boutlander\b/, make: "Mitsubishi", model: "Outlander" },
  { re: /\bf-?pace\b/, make: "Jaguar", model: "F-Pace" },
...
const MAKE_NAMES: Array<{ match: RegExp; make: string }> = [
  ...
  { match: /\bland rover\b|\bevoque\b/, make: "Land Rover" },
  { match: /\bjeep\b/, make: "Jeep" },
  { match: /\balfa/, make: "Alfa Romeo" },
  { match: /\bmitsubishi\b/, make: "Mitsubishi" },
